To build, you must specify install path of wxWidgets with WX_WIN_PATH or make a symlink wx_win in "dep" folder from project root to it. The install path should contain lib and include folders.
